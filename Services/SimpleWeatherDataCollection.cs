...
{
    internal class SimpleWeatherDataCollection : IWeatherDataCollection<SimpleWeatherData>
    {
        private readonly IList<SimpleWeatherData> weatherData;
        public DateTime Start { get; private set; }
        public DateTime End { get; private set; }

        internal SimpleWeatherDataCollection(no_met_metdata_Metdata metData)
        {
